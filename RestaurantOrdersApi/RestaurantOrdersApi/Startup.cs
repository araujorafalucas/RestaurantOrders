...
namespace RestaurantOrdersApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AppDbContext>(options => options.UseSqlServer(Configuration["ConectionStringDataBase"]));

            services.AddScoped<IDishMealTimeService, DishMealTimeService>();
